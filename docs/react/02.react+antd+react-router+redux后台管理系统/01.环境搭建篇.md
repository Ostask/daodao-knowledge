...
![](https://gitee.com/knif/img/raw/master/20230325142734.png)  
根据官方文档，我们运行
```
npm create vite@latest
```
起好自己的项目名字，然后选react  
![](https://gitee.com/knif/img/raw/master/c1a11381848621d1a6bf855d6de7a62.png)

嘿，我就是要用ts,所以选typescript，当然你可以不选  
![](https://gitee.com/knif/img/raw/master/a45f7f19acf2839db61cb9dc9b47171.png)

成功拉：  
![](https://gitee.com/knif/img/raw/master/3cd7210f3645b27963234f8d48bac46.png)
...
npm run dev
```
![](https://gitee.com/knif/img/raw/master/20c50bde558ed55ca5d90986499d776.png)  
不错不错值得表扬

### 删除多余文件
不过这里面很多文件都是不需要的，我们把它删掉，现在是删除之后的目录  
![](https://gitee.com/knif/img/raw/master/20230325145055.png)
...
## 配置vite
 ...
 ![](https://gitee.com/knif/img/raw/master/20230325160204.png)  
...
![](https://gitee.com/knif/img/raw/master/20230325162332.png)  
...
现在就不报错了.
 ...
 ![](https://gitee.com/knif/img/raw/master/20230325164344.png)  
 因此直接将less装上就行了
 ```
 npm i -D less
 ```
...
export default defineConfig((mode: ConfigEnv):UserConfig => {
 ...
 ![](https://gitee.com/knif/img/raw/master/20230325184744.png)
 ![](https://gitee.com/knif/img/raw/master/20230325185513.png)
 ![](https://gitee.com/knif/img/raw/master/20230325185653.png)  
...
## 配置tsconfig
 ...
 ```
### ts报错某某模块找不到
![](https://gitee.com/knif/img/raw/master/0eb259d2cc4691679d981a3ddcd5070.png)  
