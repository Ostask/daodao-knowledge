...
![](https://cdn.JsDelivr.net/gh/Ostask/img-bed//2021020411.gif)

## 原理
因为我的测点正好是正方形，所以我的原理就是，找了这个正方形周围的27个点来判断这27个点到测点表面的射线，最后对比哪个点碰到的障碍物少，哪个点就是最佳观测点，然后将摄像头平滑的移到这个点上去。
![](https://cdn.JsDelivr.net/gh/Ostask/img-bed//20210220220411143932.png)
...
![](https://cdn.JsDelivr.net/gh/Ostask/img-bed//20210220220411144519.png)
