...
使用后期处理前：
![](https://gitee.com/knif/img/raw/master/img/20210617155230319.gif)
使用后期处理后：
![](https://gitee.com/knif/img/raw/master/img/20210617155421604.gif)
...
### 色彩空间
![](https://gitee.com/knif/img/raw/master/img/20210617155751974.png)
...
![](https://gitee.com/knif/img/raw/master/img/20210617155941689.png)
在着色器中色值的提取与色彩的计算操作一般都是在线性空间。在`webgl`中，贴图或者颜色以`srgb`传入时，必须转换为线性空间。计算完输出后再将线性空间转为`srgb`空间。

![](https://gitee.com/knif/img/raw/master/img/20210617160057325.png)
### ThreeJS 色彩空间转换
...
```
然后看下效果：
![](https://gitee.com/knif/img/raw/master/img/20210617164610338.gif)
颜色正常了~
