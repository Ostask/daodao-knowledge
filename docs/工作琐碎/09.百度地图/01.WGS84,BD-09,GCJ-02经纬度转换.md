---
title: WGS84,BD-09,GCJ-02经纬度转换
date: 2022-12-07 08:38:45
permalink: /pages/e03cd3/
categories:
  - 工作琐碎
  - 百度地图
tags:
    -
---
最近做的一个项目客户反应地图上的定位和实际上的定位相差巨大，我查过资料后发现是因为客户提供的坐标为WGS84，而我使用的百度地图为BD-09,其实百度也有转换WGS84到BD-09的服务，但是因为是异步而且限制了每次只能10个点，于是我在网上找到了转换的方法，方法如下：
```js
// 定义一些常量
